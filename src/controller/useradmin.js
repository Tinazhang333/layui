...
layui.define(['table', 'form', 'commonReq'], function(exports) {
	...
	// 		align: 'center',
	// 		fixed: 'right',
	// 		toolbar: '#table-useradmin-admin-role2'
	// 	}]
	...
	//    ,url: 'http://192.168.1.2:60650/api/admin/sysuser/sys_role/getRoleByPage' ,//模拟接口
	// ,url:setter.address+'/sysuser/sys_role/getRoleByPage'
	//    toolbar: '#toolbarDemo',
	//    page: false
	//     ,cols: [[
	// 	  {type:'radio'}
	...
	//       ,{title: '操作', width: 150, align: 'center', fixed: 'right', toolbar: '#table-useradmin-admin-role2'}
